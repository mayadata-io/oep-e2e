# Verify mirror cstor pool cluster after node reboot

<b>tcid:</b> TCID-DIR-OP-CSTOR-POOL-MIRROR-RECOMMEND-REBOOT-NODE <br>
<b>name:</b> "Verify mirror cstor pool cluster after node reboot"<br>
