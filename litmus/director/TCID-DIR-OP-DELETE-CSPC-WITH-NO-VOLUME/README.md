...
<b>tcid:</b> TCID-DIR-OP-DELETE-CSPC-WITH-NO-VOLUME <br>
<b>name:</b> "Delete CSPC created via director which has no volume"<br>
...
<table>
  ...
  <tr>
    ...
    <td> Delete CSPC created via director which has no volume </td>
    <td> GKE </td>
  </tr>
</table>
