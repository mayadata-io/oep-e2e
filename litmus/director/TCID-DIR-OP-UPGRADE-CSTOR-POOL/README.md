# Upgrade  cstor pool via  Director

---
tcid: TCID-DIR-OP-UPGRADE-CSTOR-POOL
name: "Upgrade cstor pool via Director"
...
<table>
  ...
  <tr>
    ...
    <td> Upgrade cstor pool via Director </td>
    <td> GKE </td>
  </tr>
</table>
...
- All the OpenEBS ControlPlane components and pool pods should get upgraded should be in running state after upgrade.
