...
const siteConfig = {
  ...
  tagline: 'Tesplan for MayaData OEP',
  url: 'https://testplan.mayadata.io', // Your website URL
  ...
  headerLinks: [
    {href: "https://ci.mayadata.io", label: "ci.mayadata.io"},
    {search: true}
  ],
  ...
  footerIcon: 'img/xlitmus-logo-dark-bg-stacked.svg',
  favicon: 'img/favicon.ico',

  /* Colors for website */
  colors: {
    primaryColor: '#0000cd',
    secondaryColor: '#00ed00',
  },
