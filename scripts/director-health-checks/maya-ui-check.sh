...
> oep/litmus/director/common-checks/ui_run_litmus_test.yml

cat oep/litmus/director/common-checks/ui_run_litmus_test.yml

# Run common health check litmus job
kubectl create -f oep/litmus/director/common-checks/ui_run_litmus_test.yml
