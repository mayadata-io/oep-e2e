...
-e 's/value: pod-name/value: consul/g' oep-e2e/litmus/director/common-checks/run_litmus_test.yml \
> oep-e2e/litmus/director/common-checks/consul_run_litmus_test.yml

cat oep-e2e/litmus/director/common-checks/consul_run_litmus_test.yml

# Run common health check litmus job
kubectl create -f oep-e2e/litmus/director/common-checks/consul_run_litmus_test.yml
...
kubectl create -f oep-e2e/litmus/director/consul/run_litmus_test.yml
