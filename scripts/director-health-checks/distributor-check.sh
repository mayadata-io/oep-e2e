...
-e 's/value: pod-name/value: distributor/g' oep/litmus/director/common-checks/run_litmus_test.yml \
> oep/litmus/director/common-checks/distributor_run_litmus_test.yml

cat oep/litmus/director/common-checks/distributor_run_litmus_test.yml

# Run common health check litmus job
kubectl create -f oep/litmus/director/common-checks/distributor_run_litmus_test.yml
